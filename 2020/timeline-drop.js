...
World.add(
  engine.world,
  Bodies.fromVertices(380, 120, font, {
    isStatic: true,
...
var boxA = Bodies.rectangle(400, 200, 10, 10, {
  render: { fillStyle: '#40c463' },
});
var boxB = Bodies.rectangle(450, 50, 10, 10, {
  render: { fillStyle: '#216e39' },
});
ground;
